...
const AddBlog = ({ addBlog, blogFor, onClose }) => {
    const [title, setTitle] = useState('');
    // const [blogType, setBlogType] = useState(blogFor);
    ...
    return (
        <div className="bg-white p-4 rounded-3xl w-[75vw] lg:w-[50vw] h-[70vh] max-h-[95vh] overflow-auto mx-auto px-10 py-8">
            ...
            <form onSubmit={handleSubmit} className='flex flex-col'>
                <div className='flex flex-wrap gap-2 mb-4'>
                    ...
                    {/* <div className="pr-2">
                            ...
                            >
                            <option value="" selected>Please select a blog type</option>
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-medium">Add Image</label>
                    <UploadComponent handleFileChange={handleFileChange} inputId={"blogImageFile"} />
                </div>
