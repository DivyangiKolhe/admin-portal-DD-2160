...
const EditYogaModal = ({ masterYoga, onClose }) => {
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            ...
            >
              ...
              <MenuItem value="">Select Master Yoga</MenuItem>
          ...
          <Grid item xs={12}>
            <TextField
              fullWidth
              label="Yoga Video Link"
              variant="outlined"
              name="yogaVideoLink"
              value={editedYoga.yogaVideoLink}
              onChange={handleInputChange}
            />
            <Divider textAlign="center">OR</Divider>
            <div className="mb-4">
