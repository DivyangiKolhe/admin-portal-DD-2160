...
const neurorehabAPI = axios.create({
  baseURL: "https://apidev.manastik.com/api/neurorehab/v1",
});

// Create an interceptor to check for expired tokens
neurorehabAPI.interceptors.response.use((response) => response,
  async (error) => {
